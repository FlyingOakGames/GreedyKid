...
namespace Ionic.Zlib
{
    ...
    internal class ZlibBaseStream : System.IO.Stream
    {
        ...
        protected internal bool _dontCheckGZipTrailer;
            ...
            : base()
        {
            ...
            this._dontCheckGZipTrailer = dontCheckGZipTrailer;
        ...
        private void finish()
        {
            ...
            else if (_streamMode == StreamMode.Reader)
            {
                if (_flavor == ZlibStreamFlavor.GZIP)
                {
                    if (!_wantCompress)
                    {
                        // don't check GZIP trailer
                        if (_dontCheckGZipTrailer)
                            return;
