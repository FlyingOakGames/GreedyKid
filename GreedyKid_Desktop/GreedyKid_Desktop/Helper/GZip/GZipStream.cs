...
namespace Ionic.Zlib
{
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        public GZipStream(Stream stream, CompressionMode mode)
            : this(stream, mode, CompressionLevel.Default, false, false)
        {
        }
        ...
        public GZipStream(Stream stream, CompressionMode mode, CompressionLevel level)
            : this(stream, mode, level, false, false)
        {
        }
        ...
        ///   Create a <c>GZipStream</c> using the specified <c>CompressionMode</c>, and
        ///   explicitly specify whether the stream should be left open after Deflation
        ///   or Inflation, and if the GZip trailer should be verified.
        /// </summary>
        ///
        /// <remarks>
        /// <para>
        ...
        ///   inflation/deflation.
        /// </param>
        /// <param name="dontCheckGZipTrailer">
        ///   true if the application would skip verifying the CRC32 of the GZip trailer (this can come handy if the stream is not read to its ends).
        /// </param>
        public GZipStream(Stream stream, CompressionMode mode, bool leaveOpen, bool dontCheckGZipTrailer)
            : this(stream, mode, CompressionLevel.Default, leaveOpen, dontCheckGZipTrailer)
        {
        }
        ...
        /// <param name="level">A tuning knob to trade speed for effectiveness.</param>
        /// <param name="dontCheckGZipTrailer">true if the application would skip verifying the CRC32 of the GZip trailer (this can come handy if the stream is not read to its ends).</param>
        public GZipStream(Stream stream, CompressionMode mode, CompressionLevel level, bool leaveOpen, bool dontCheckGZipTrailer)
        {
            _baseStream = new ZlibBaseStream(stream, mode, level, ZlibStreamFlavor.GZIP, leaveOpen, dontCheckGZipTrailer);
        }
