...
#if OSX
			internal const string NativeLibraryName = "libsteam_api.dylib";
#elif LINUX
			internal const string NativeLibraryName = "libsteam_api.so";
#else
		internal const string NativeLibraryName = "steam_api64.dll"; // Windows
#endif
